  ...
  return ( 
    <>
      <div className="sticky w-full top-0 flex items-center justify-between px-2 nav_bg_gradient border-b-[1px] border-slate-500/30 z-50 select-none">
        ...
        <img className="w-[60px] h-[45px] md:w-[80px] md:h-[60px] cursor-pointer hover:scale-110 hover:-rotate-2 duration-300" onClick={() => navigate('/home')} src="/resto_logo.webp" alt="Savory Haven logo" loading="lazy"/>
      </div>
      {
      mobileNavOpen ? 
      <>
