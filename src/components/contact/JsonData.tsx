...
const JsonData = ({ formData }: JsonDataProps) => {
  return (
    <div className="min-h-[200px] w-[250px] xs:w-[300px] flex items-center justify-start md:row-start-2 md:col-start-0 md:self-center md:justify-self-center text-sm sm:text-base text_emphasis overflow-hidden">
      <code>
